export const infoStyles = {
  ...
  logo: "w-14 h-14 mx-auto mb-3 object-contain",
  title: "font-black text-slate-900 dark:text-white text-xl tracking-tight",
  ...
  footerBox: "pt-6 text-center border-t border-slate-100 dark:border-slate-800",
  versionText: "text-[10px] text-slate-400"
};
