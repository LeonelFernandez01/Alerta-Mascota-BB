export const feedStyles = {
  ...
  infoBanner: "p-4 bg-indigo-50/50 dark:bg-indigo-950/10 border border-indigo-100/50 dark:border-indigo-900/20 rounded-3xl flex items-start gap-3 transition-colors duration-300",
  ...
  emptyContainer: "text-center py-16 px-6 space-y-4 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm max-w-md mx-auto transition-colors duration-300",
  ...
  loadMoreButton: "px-6 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-indigo-600 dark:text-indigo-400 font-extrabold rounded-2xl text-xs hover:bg-slate-50 dark:hover:bg-slate-850 active:scale-95 transition-all shadow-sm cursor-pointer",
