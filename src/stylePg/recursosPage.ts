export const recursosStyles = {
  ...
  container: "w-full max-w-3xl mx-auto px-4 py-8 pb-28 md:pb-12 space-y-6",
  
  // Encabezados
  title: "font-extrabold text-slate-900 dark:text-white text-xl tracking-tight",
  ...
  badgeCommon: "px-2.5 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider",
  badgeMunicipal: "bg-indigo-50 dark:bg-indigo-950/20 text-indigo-600 dark:text-indigo-400 border border-indigo-100 dark:border-indigo-900/30",
  badgeProtectora: "bg-emerald-50 dark:bg-emerald-950/20 text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/30",
  
  // Contenido interno de la tarjeta
  description: "text-slate-600 dark:text-slate-300 text-xs mt-2 leading-relaxed",
  metaList: "mt-4 space-y-2 text-slate-505 dark:text-slate-400 text-xs",
  metaItem: "flex items-center gap-2",
  metaBullet: "w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-700",
  metaIcon: "w-4 h-4 text-slate-400 flex-shrink-0 mt-0.5",
  divider: "h-px bg-slate-100/80 dark:bg-slate-800/80 w-full my-4",
